...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [9] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 2, 0, 4),
  [11] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_relation, 2, 0, 4), SHIFT(4),
  ...
  [26] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 3, 0, 7),
  [28] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_relation, 3, 0, 7), SHIFT(5),
  [31] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 3, 0, 4),
  [33] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 3, 0, 4),
  [35] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 4, 0, 7),
  [37] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 4, 0, 7),
  [39] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_ref, 2, 0, 1),
  [41] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_ref, 2, 0, 1),
  ...
  [57] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sources, 2, 0, 3),
  [59] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sources, 2, 0, 3),
  [61] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 6), SHIFT_REPEAT(36),
  [64] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 6), SHIFT_REPEAT(19),
  [67] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 6),
  [69] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 6),
  ...
  [77] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_def, 1, 0, 0),
  [79] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_def, 1, 0, 0),
  [81] = {.entry = {.count = 1, .reusable = true}}, SHIFT(75),
  [83] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__words, 1, 0, 2),
  [85] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__words, 1, 0, 2),
  [87] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_def, 2, 0, 0),
  [89] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_def, 2, 0, 0),
  ...
  [98] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_targets, 2, 0, 3),
  [100] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_targets, 2, 0, 3), SHIFT(6),
  [103] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 6),
  [105] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 6), SHIFT_REPEAT(6),
  [108] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 6), SHIFT_REPEAT(6),
  [111] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 6), SHIFT_REPEAT(19),
  [114] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_def, 3, 0, 0),
  [116] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_def, 3, 0, 0),
  [118] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment, 1, 0, 0),
  [120] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_comment, 1, 0, 0),
  ...
  [130] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_aliases, 4, 0, 0),
  [132] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_aliases, 4, 0, 0),
  [134] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 5),
  [136] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 5),
  ...
  [152] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_def, 4, 0, 0),
  [154] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_def, 4, 0, 0),
  ...
  [160] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family_name, 1, 0, 0),
  [162] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_family_name, 1, 0, 0),
  [164] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_root_repeat1, 2, 0, 0),
  [166] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_root_repeat1, 2, 0, 0), SHIFT_REPEAT(64),
  [169] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_root_repeat1, 2, 0, 0),
  [171] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root, 3, 0, 0),
  [173] = {.entry = {.count = 1, .reusable = true}}, SHIFT(52),
  [175] = {.entry = {.count = 1, .reusable = false}}, SHIFT(80),
  [177] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relations, 2, 0, 0),
  [179] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_relations, 2, 0, 0), SHIFT(23),
  [182] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relations, 2, 0, 0),
  [184] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root, 1, 0, 0),
  [186] = {.entry = {.count = 1, .reusable = true}}, SHIFT(48),
  [188] = {.entry = {.count = 1, .reusable = false}}, SHIFT(77),
  [190] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root, 2, 0, 0),
  ...
  [198] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family, 4, 0, 0),
  [200] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_family, 4, 0, 0), SHIFT(16),
  [203] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_family, 4, 0, 0), SHIFT(46),
  [206] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root, 4, 0, 0),
  [208] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family, 3, 0, 0),
  [210] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_family, 3, 0, 0), SHIFT(15),
  [213] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_family, 3, 0, 0), SHIFT(46),
  [216] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_family_repeat1, 2, 0, 0),
  [218] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_family_repeat1, 2, 0, 0), SHIFT_REPEAT(46),
  [221] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_relations_repeat1, 2, 0, 0),
  [223] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_relations_repeat1, 2, 0, 0), SHIFT_REPEAT(23),
  [226] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_relations_repeat1, 2, 0, 0),
  [228] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relations, 1, 0, 0),
  [230] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_relations, 1, 0, 0), SHIFT(23),
  [233] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relations, 1, 0, 0),
  [235] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family, 5, 0, 0),
  [237] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_family, 5, 0, 0),
  [239] = {.entry = {.count = 1, .reusable = true}}, SHIFT(78),
  [241] = {.entry = {.count = 1, .reusable = true}}, SHIFT(33),
  [243] = {.entry = {.count = 1, .reusable = true}}, SHIFT(31),
  [245] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_family_repeat1, 2, 0, 0),
  [247] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family, 1, 0, 0),
  [249] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_family, 1, 0, 0), SHIFT(18),
  [252] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_family, 1, 0, 0), SHIFT(50),
  [255] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 4, 0, 4),
  [257] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 4, 0, 4),
  [259] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 5, 0, 7),
  [261] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 5, 0, 7),
  [263] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_family, 3, 0, 0),
  [265] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family_name, 2, 0, 0),
  [267] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_family_name, 2, 0, 0),
  [269] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family, 6, 0, 0),
  [271] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_family, 6, 0, 0),
  [273] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_name_aliases_repeat1, 2, 0, 0), SHIFT_REPEAT(78),
  [276] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_name_aliases_repeat1, 2, 0, 0),

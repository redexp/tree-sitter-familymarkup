...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (set_contains(sym_name_character_set_1, 611, lookahead)) ADVANCE(26);
    ...
    case 5:
      ...
      if (lookahead == '\t' ||
          lookahead == ' ') SKIP(5);
      if (set_contains(sym_name_character_set_1, 611, lookahead)) ADVANCE(27);
    ...
    case 26:
      ...
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ') ADVANCE(4);
      if (set_contains(aux_sym_unknown_token1_character_set_2, 437, lookahead)) ADVANCE(26);
      END_STATE();
    case 27:
      ACCEPT_TOKEN(sym_name);
      if (set_contains(sym_name_character_set_2, 434, lookahead)) ADVANCE(27);
      END_STATE();
    case 28:
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [9] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 2, 0, 1),
  [11] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_relation, 2, 0, 1), SHIFT(3),
  ...
  [26] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 3, 0, 1),
  [28] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 3, 0, 1),
  [30] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 3, 0, 4),
  [32] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_relation, 3, 0, 4), SHIFT(5),
  [35] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 4, 0, 4),
  [37] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 4, 0, 4),
  ...
  [47] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sources, 2, 0, 3),
  [49] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sources, 2, 0, 3),
  [51] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sources, 1, 0, 0),
  [53] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sources, 1, 0, 0),
  [55] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 6), SHIFT_REPEAT(36),
  [58] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 6), SHIFT_REPEAT(14),
  [61] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 6),
  [63] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 6),
  [65] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_ref, 1, 0, 0),
  [67] = {.entry = {.count = 1, .reusable = true}}, SHIFT(13),
  [69] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_ref, 1, 0, 0),
  [71] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 5),
  [73] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 5),
  ...
  [85] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_targets, 2, 0, 3),
  [87] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_targets, 2, 0, 3), SHIFT(6),
  [90] = {.entry = {.count = 1, .reusable = true}}, SHIFT(6),
  [92] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_targets, 1, 0, 0),
  [94] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_targets, 1, 0, 0), SHIFT(6),
  [97] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_def, 2, 0, 0),
  [99] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_def, 2, 0, 0),
  [101] = {.entry = {.count = 1, .reusable = true}}, SHIFT(74),
  [103] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_def, 1, 0, 0),
  [105] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_def, 1, 0, 0),
  [107] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_def, 3, 0, 0),
  [109] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_def, 3, 0, 0),
  [111] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 6),
  [113] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 6), SHIFT_REPEAT(6),
  [116] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 6), SHIFT_REPEAT(6),
  [119] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 6), SHIFT_REPEAT(14),
  ...
  [138] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_num_unknown, 2, 0, 0),
  [140] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_num_unknown, 2, 0, 0),
  ...
  [146] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 5),
  [148] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 5),
  [150] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment, 2, 0, 0),
  [152] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_comment, 2, 0, 0),
  [154] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_aliases, 3, 0, 0),
  [156] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_aliases, 3, 0, 0),
  [158] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_def, 4, 0, 0),
  [160] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_def, 4, 0, 0),
  [162] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family_name, 1, 0, 0),
  [164] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_family_name, 1, 0, 0),
  [166] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_root_repeat1, 2, 0, 0),
  [168] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_root_repeat1, 2, 0, 0), SHIFT_REPEAT(64),
  [171] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_root_repeat1, 2, 0, 0),
  [173] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relations, 1, 0, 0),
  [175] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_relations, 1, 0, 0), SHIFT(24),
  [178] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relations, 1, 0, 0),
  ...
  [186] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relations, 2, 0, 0),
  [188] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_relations, 2, 0, 0), SHIFT(24),
  [191] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relations, 2, 0, 0),
  [193] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root, 2, 0, 0),
  ...
  [201] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family, 4, 0, 0),
  [203] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_family, 4, 0, 0), SHIFT(17),
  [206] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_family, 4, 0, 0), SHIFT(45),
  [209] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root, 3, 0, 0),
  [211] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_family_repeat1, 2, 0, 0),
  [213] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_family_repeat1, 2, 0, 0), SHIFT_REPEAT(45),
  [216] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_relations_repeat1, 2, 0, 0),
  [218] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_relations_repeat1, 2, 0, 0), SHIFT_REPEAT(24),
  [221] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_relations_repeat1, 2, 0, 0),
  [223] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root, 4, 0, 0),
  [225] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family, 3, 0, 0),
  [227] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_family, 3, 0, 0), SHIFT(15),
  [230] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_family, 3, 0, 0), SHIFT(45),
  [233] = {.entry = {.count = 1, .reusable = true}}, SHIFT(52),
  [235] = {.entry = {.count = 1, .reusable = false}}, SHIFT(75),
  [237] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family, 5, 0, 0),
  [239] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_family, 5, 0, 0),
  [241] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_name_aliases_repeat1, 2, 0, 0), SHIFT_REPEAT(81),
  [244] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_name_aliases_repeat1, 2, 0, 0),
  [246] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_family, 3, 0, 0),
  [248] = {.entry = {.count = 1, .reusable = true}}, SHIFT(81),
  [250] = {.entry = {.count = 1, .reusable = true}}, SHIFT(35),
  [252] = {.entry = {.count = 1, .reusable = true}}, SHIFT(32),
  [254] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_family_repeat1, 2, 0, 0),
  [256] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family, 1, 0, 0),
  [258] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_family, 1, 0, 0), SHIFT(16),
  [261] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_family, 1, 0, 0), SHIFT(48),
  [264] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 4, 0, 1),
  [266] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 4, 0, 1),
  [268] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 5, 0, 4),
  [270] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 5, 0, 4),
  [272] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family_name, 2, 0, 0),
  [274] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_family_name, 2, 0, 0),
  [276] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family, 6, 0, 0),
  [278] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_family, 6, 0, 0),

...
enum ts_symbol_identifiers {
  ...
  aux_sym_relations_repeat1 = 18,
  aux_sym_sources_repeat1 = 19,
  aux_sym_targets_repeat1 = 20,
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [13] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_relations_repeat1, 2, 0, 0), SHIFT_REPEAT(49),
  [16] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relations, 3, 0, 0),
  [18] = {.entry = {.count = 1, .reusable = false}}, SHIFT(49),
  [20] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relations, 2, 0, 0),
  [22] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_targets, 2, 0, 0),
  [24] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_targets, 2, 0, 0), SHIFT(2),
  [27] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_relations, 3, 0, 0), SHIFT(49),
  [30] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root, 2, 0, 0),
  [32] = {.entry = {.count = 1, .reusable = false}}, SHIFT(2),
  [34] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_targets, 3, 0, 0),
  [36] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 0),
  [38] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 0), SHIFT_REPEAT(2),
  [41] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root, 3, 0, 0),
  [43] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_targets, 3, 0, 0), SHIFT(2),
  [46] = {.entry = {.count = 1, .reusable = true}}, SHIFT(54),
  [48] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_relations_repeat1, 2, 0, 0), SHIFT_REPEAT(49),
  [51] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_relations, 2, 0, 0), SHIFT(49),
  [54] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_root_repeat1, 2, 0, 0),
  [56] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_root_repeat1, 2, 0, 0), SHIFT_REPEAT(2),
  [59] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_aliases, 3, 0, 0),
  [61] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_aliases, 3, 0, 0),
  [63] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_desc, 2, 0, 0),
  [65] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_desc, 2, 0, 0),
  [67] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_targets, 1, 0, 0),
  [69] = {.entry = {.count = 1, .reusable = false}}, SHIFT(6),
  [71] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_targets, 1, 0, 0),
  [73] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_targets, 2, 0, 0), SHIFT(14),
  [76] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 0),
  [78] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 0), SHIFT_REPEAT(22),
  ...
  [85] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 0), SHIFT_REPEAT(14),
  [88] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_aliases, 2, 0, 0),
  [90] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_aliases, 2, 0, 0),
  [92] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_targets, 3, 0, 0), SHIFT(14),
  [95] = {.entry = {.count = 1, .reusable = true}}, SHIFT(49),
  [97] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_aliases, 5, 0, 0),
  [99] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_aliases, 5, 0, 0),
  [101] = {.entry = {.count = 1, .reusable = true}}, SHIFT(21),
  [103] = {.entry = {.count = 1, .reusable = true}}, SHIFT(44),
  [105] = {.entry = {.count = 1, .reusable = true}}, SHIFT(46),
  [107] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 3, 0, 0),
  [109] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 3, 0, 0),
  [111] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sources, 3, 0, 0),
  [113] = {.entry = {.count = 1, .reusable = true}}, SHIFT(22),
  [115] = {.entry = {.count = 1, .reusable = true}}, SHIFT(29),
  [117] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family, 1, 0, 0),
  [119] = {.entry = {.count = 1, .reusable = true}}, SHIFT(28),
  [121] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_family, 1, 0, 0),
  [123] = {.entry = {.count = 1, .reusable = false}}, SHIFT(9),
  [125] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relations, 1, 0, 0),
  [127] = {.entry = {.count = 1, .reusable = true}}, SHIFT(16),
  [129] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relations, 1, 0, 0),
  [131] = {.entry = {.count = 1, .reusable = true}}, SHIFT(14),
  [133] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sources, 2, 0, 0),
  ...
  [143] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sources, 1, 0, 0),
  [145] = {.entry = {.count = 1, .reusable = true}}, SHIFT(45),
  [147] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family, 3, 0, 0),
  ...
  [161] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_family, 1, 0, 0), SHIFT(27),
  [164] = {.entry = {.count = 1, .reusable = true}}, SHIFT(31),
  [166] = {.entry = {.count = 1, .reusable = true}}, SHIFT(41),
  [168] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_relations, 1, 0, 0), SHIFT(5),
  [171] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root, 1, 0, 0),

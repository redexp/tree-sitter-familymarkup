...
enum ts_symbol_identifiers {
  ...
  aux_sym_family_repeat1 = 35,
  aux_sym_relations_repeat1 = 36,
  aux_sym_sources_repeat1 = 37,
  aux_sym_targets_repeat1 = 38,
  aux_sym_name_aliases_repeat1 = 39,
  anon_alias_sym__words = 40,
};
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (set_contains(sym_name_character_set_1, 611, lookahead)) ADVANCE(34);
      if (set_contains(sym_words_character_set_1, 623, lookahead)) ADVANCE(36);
      END_STATE();
    case 1:
      if (lookahead == '\n') ADVANCE(14);
      END_STATE();
    ...
    case 3:
      ...
      if (set_contains(sym_name_character_set_1, 611, lookahead)) ADVANCE(33);
      if (set_contains(sym_words_character_set_2, 627, lookahead)) ADVANCE(35);
      if (set_contains(sym_name_character_set_2, 434, lookahead)) ADVANCE(7);
      END_STATE();
    case 4:
      if (lookahead == '\n') ADVANCE(15);
      if (lookahead == '?') ADVANCE(32);
      if (set_contains(sym_unknown_character_set_1, 437, lookahead)) ADVANCE(7);
      END_STATE();
    case 5:
      if (lookahead == '\n') ADVANCE(13);
    ...
    case 8:
      ...
      if (set_contains(sym_words_character_set_1, 623, lookahead)) ADVANCE(28);
    ...
    case 28:
      ACCEPT_TOKEN(aux_sym_comment_token1);
      if (lookahead == '\n') ADVANCE(36);
      if (set_contains(sym_words_character_set_2, 627, lookahead)) ADVANCE(28);
      if (lookahead != 0) ADVANCE(31);
      END_STATE();
    case 29:
      ACCEPT_TOKEN(aux_sym_comment_token1);
    ...
    case 33:
      ...
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ') ADVANCE(7);
      if (set_contains(sym_name_character_set_2, 434, lookahead)) ADVANCE(33);
      END_STATE();
    case 34:
      ACCEPT_TOKEN(sym_name);
      if (set_contains(sym_name_character_set_2, 434, lookahead)) ADVANCE(34);
      END_STATE();
    case 35:
    ...
    case 36:
      ACCEPT_TOKEN(sym_words);
      if (set_contains(sym_words_character_set_2, 627, lookahead)) ADVANCE(36);
      END_STATE();
    case 37:
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    [sym_root] = STATE(76),
    [sym_family] = STATE(47),
    [sym_name_def] = STATE(66),
    [sym_new_surname] = STATE(73),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [13] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 2, 0, 3),
  [15] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 2, 0, 3),
  [17] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_relation, 2, 0, 3), SHIFT(5),
  ...
  [34] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_relation, 3, 0, 6), SHIFT(4),
  [37] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 4, 0, 6),
  [39] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 4, 0, 6),
  [41] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 3, 0, 3),
  [43] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 3, 0, 3),
  [45] = {.entry = {.count = 1, .reusable = true}}, SHIFT(31),
  [47] = {.entry = {.count = 1, .reusable = true}}, SHIFT(64),
  [49] = {.entry = {.count = 1, .reusable = true}}, SHIFT(19),
  [51] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sources, 2, 0, 2),
  [53] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sources, 2, 0, 2),
  [55] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 5), SHIFT_REPEAT(64),
  [58] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 5), SHIFT_REPEAT(19),
  [61] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 5),
  [63] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 5),
  [65] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sources, 1, 0, 0),
  [67] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sources, 1, 0, 0),
  [69] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_ref, 1, 0, 0),
  [71] = {.entry = {.count = 1, .reusable = true}}, SHIFT(12),
  [73] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_ref, 1, 0, 0),
  [75] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 4),
  [77] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 4),
  [79] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_ref, 2, 0, 0),
  [81] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_ref, 2, 0, 0),
  [83] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_def, 1, 0, 0),
  [85] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_def, 1, 0, 0),
  [87] = {.entry = {.count = 1, .reusable = true}}, SHIFT(71),
  [89] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_targets, 1, 0, 0),
  [91] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_targets, 1, 0, 0), SHIFT(6),
  [94] = {.entry = {.count = 1, .reusable = true}}, SHIFT(6),
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_def, 2, 0, 0),
  [98] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_def, 2, 0, 0),
  [100] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 5),
  [102] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 5), SHIFT_REPEAT(6),
  [105] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 5), SHIFT_REPEAT(6),
  [108] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 5), SHIFT_REPEAT(19),
  [111] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root, 4, 0, 0),
  [113] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root, 2, 0, 0),
  [115] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__words, 1, 0, 1),
  [117] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__words, 1, 0, 1),
  [119] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_targets, 2, 0, 2),
  [121] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_targets, 2, 0, 2), SHIFT(6),
  [124] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_def, 3, 0, 0),
  [126] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_def, 3, 0, 0),
  [128] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root, 3, 0, 0),
  [130] = {.entry = {.count = 1, .reusable = true}}, SHIFT(9),
  [132] = {.entry = {.count = 1, .reusable = false}}, SHIFT(10),
  [134] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment, 1, 0, 0),
  [136] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_comment, 1, 0, 0),
  [138] = {.entry = {.count = 1, .reusable = false}}, SHIFT(39),
  [140] = {.entry = {.count = 1, .reusable = true}}, SHIFT(2),
  [142] = {.entry = {.count = 1, .reusable = false}}, SHIFT(2),
  [144] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_def, 4, 0, 0),
  [146] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_def, 4, 0, 0),
  [148] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 4),
  [150] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 4),
  [152] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_num_unknown, 2, 0, 0),
  [154] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_num_unknown, 2, 0, 0),
  [156] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_aliases, 2, 0, 0),
  [158] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_aliases, 2, 0, 0),
  [160] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_aliases, 4, 0, 0),
  [162] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_aliases, 4, 0, 0),
  [164] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_aliases, 3, 0, 0),
  [166] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_aliases, 3, 0, 0),
  [168] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment, 2, 0, 0),
  [170] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_comment, 2, 0, 0),
  [172] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family, 3, 0, 0),
  [174] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_family, 3, 0, 0), SHIFT(29),
  [177] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_family, 3, 0, 0), SHIFT(54),
  [180] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family, 4, 0, 0),
  [182] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_family, 4, 0, 0), SHIFT(25),
  [185] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_family, 4, 0, 0), SHIFT(54),
  [188] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_root_repeat1, 2, 0, 0),
  [190] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_root_repeat1, 2, 0, 0), SHIFT_REPEAT(26),
  [193] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_root_repeat1, 2, 0, 0),
  [195] = {.entry = {.count = 1, .reusable = true}}, SHIFT(17),
  [197] = {.entry = {.count = 1, .reusable = false}}, SHIFT(80),
  [199] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relations, 1, 0, 0),
  [201] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_relations, 1, 0, 0), SHIFT(38),
  [204] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relations, 1, 0, 0),
  [206] = {.entry = {.count = 1, .reusable = true}}, SHIFT(22),
  [208] = {.entry = {.count = 1, .reusable = false}}, SHIFT(82),
  [210] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root, 1, 0, 0),
  ...
  [218] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_family_repeat1, 2, 0, 0), SHIFT_REPEAT(54),
  [221] = {.entry = {.count = 1, .reusable = true}}, SHIFT(32),
  [223] = {.entry = {.count = 1, .reusable = false}}, SHIFT(15),
  [225] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_relations_repeat1, 2, 0, 0),
  [227] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_relations_repeat1, 2, 0, 0), SHIFT_REPEAT(38),
  [230] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_relations_repeat1, 2, 0, 0),
  [232] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relations, 2, 0, 0),
  [234] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_relations, 2, 0, 0), SHIFT(38),
  [237] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relations, 2, 0, 0),
  [239] = {.entry = {.count = 1, .reusable = true}}, SHIFT(45),
  [241] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family, 5, 0, 0),
  [243] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_family, 5, 0, 0),
  [245] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 5, 0, 6),
  [247] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 5, 0, 6),
  [249] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_name_aliases_repeat1, 2, 0, 0), SHIFT_REPEAT(75),
  [252] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_name_aliases_repeat1, 2, 0, 0),
  [254] = {.entry = {.count = 1, .reusable = true}}, SHIFT(15),
  [256] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family, 6, 0, 0),
  [258] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_family, 6, 0, 0),
  [260] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_family, 3, 0, 0),
  [262] = {.entry = {.count = 1, .reusable = true}}, SHIFT(11),
  [264] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 4, 0, 3),
  [266] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 4, 0, 3),
  [268] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family, 1, 0, 0),
  [270] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_family, 1, 0, 0), SHIFT(23),
  [273] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_family, 1, 0, 0), SHIFT(53),
  [276] = {.entry = {.count = 1, .reusable = true}}, SHIFT(75),
  [278] = {.entry = {.count = 1, .reusable = true}}, SHIFT(35),
  [280] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_family_repeat1, 2, 0, 0),
  [282] = {.entry = {.count = 1, .reusable = true}}, SHIFT(37),
  [284] = {.entry = {.count = 1, .reusable = true}}, SHIFT(34),
  [286] = {.entry = {.count = 1, .reusable = true}}, SHIFT(70),
  [288] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_new_surname, 3, 0, 0),

...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (set_contains(sym_name_character_set_1, 611, lookahead)) ADVANCE(23);
      if (set_contains(sym_words_character_set_1, 623, lookahead)) ADVANCE(25);
      END_STATE();
    case 1:
      if (lookahead == '\n') ADVANCE(12);
      END_STATE();
    ...
    case 3:
      ...
      if (set_contains(sym_name_character_set_1, 611, lookahead)) ADVANCE(22);
    ...
    case 22:
      ...
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ') ADVANCE(7);
      if (set_contains(sym_name_character_set_2, 434, lookahead)) ADVANCE(22);
      END_STATE();
    case 23:
      ACCEPT_TOKEN(sym_name);
      if (set_contains(sym_name_character_set_2, 434, lookahead)) ADVANCE(23);
      END_STATE();
    case 24:
    ...
    case 25:
      ACCEPT_TOKEN(sym_words);
      if (set_contains(sym_words_character_set_2, 627, lookahead)) ADVANCE(25);
      END_STATE();
    case 26:
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [17] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_relation, 2, 0, 2), SHIFT(5),
  [20] = {.entry = {.count = 1, .reusable = false}}, SHIFT(41),
  [22] = {.entry = {.count = 1, .reusable = true}}, SHIFT(14),
  [24] = {.entry = {.count = 1, .reusable = false}}, SHIFT(16),
  [26] = {.entry = {.count = 1, .reusable = false}}, SHIFT(3),
  [28] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 3, 0, 3),
  [30] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 3, 0, 3),
  [32] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_relation, 3, 0, 3), SHIFT(4),
  [35] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 4, 0, 3),
  [37] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 4, 0, 3),
  [39] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 3, 0, 2),
  [41] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 3, 0, 2),
  [43] = {.entry = {.count = 1, .reusable = true}}, SHIFT(52),
  [45] = {.entry = {.count = 1, .reusable = true}}, SHIFT(44),
  [47] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sources, 2, 0, 0),
  [49] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sources, 2, 0, 0),
  [51] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 0), SHIFT_REPEAT(52),
  [54] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 0), SHIFT_REPEAT(44),
  [57] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 0),
  [59] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 0),
  [61] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sources, 1, 0, 0),
  [63] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sources, 1, 0, 0),
  [65] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_link, 1, 0, 0),
  [67] = {.entry = {.count = 1, .reusable = true}}, SHIFT(11),
  [69] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_link, 1, 0, 0),
  [71] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_link, 2, 0, 0),
  [73] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_link, 2, 0, 0),
  [75] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_targets, 2, 0, 0),
  [77] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_targets, 2, 0, 0), SHIFT(13),
  [80] = {.entry = {.count = 1, .reusable = true}}, SHIFT(13),
  [82] = {.entry = {.count = 1, .reusable = true}}, SHIFT(29),
  [84] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_targets, 1, 0, 0),
  [86] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_targets, 1, 0, 0), SHIFT(13),
  [89] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_desc, 2, 0, 0),
  [91] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_desc, 2, 0, 0),
  [93] = {.entry = {.count = 1, .reusable = true}}, SHIFT(58),
  [95] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_desc, 1, 0, 0),
  [97] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_desc, 1, 0, 0),
  [99] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 0),
  [101] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 0), SHIFT_REPEAT(13),
  [104] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 0), SHIFT_REPEAT(13),
  [107] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 0), SHIFT_REPEAT(44),
  [110] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root, 2, 0, 0),
  [112] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root, 3, 0, 0),
  [114] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_desc, 3, 0, 0),
  [116] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_desc, 3, 0, 0),
  [118] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root, 4, 0, 0),
  ...
  [128] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_aliases, 4, 0, 0),
  [130] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_aliases, 4, 0, 0),
  [132] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 0),
  ...
  [146] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_desc, 4, 0, 0),
  [148] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_desc, 4, 0, 0),
  [150] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relations, 2, 0, 0),
  [152] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_relations, 2, 0, 0), SHIFT(27),
  [155] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relations, 2, 0, 0),
  ...
  [167] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relations, 1, 0, 0),
  [169] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_relations, 1, 0, 0), SHIFT(27),
  [172] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relations, 1, 0, 0),
  [174] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_root_repeat1, 2, 0, 0),
  [176] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_root_repeat1, 2, 0, 0), SHIFT_REPEAT(24),
  [179] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_root_repeat1, 2, 0, 0),
  ...
  [189] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_relations_repeat1, 2, 0, 0),
  [191] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_relations_repeat1, 2, 0, 0), SHIFT_REPEAT(27),
  [194] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_relations_repeat1, 2, 0, 0),
  [196] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__words, 1, 0, 1),
  [198] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__words, 1, 0, 1),
  [200] = {.entry = {.count = 1, .reusable = true}}, SHIFT(61),
  [202] = {.entry = {.count = 1, .reusable = true}}, SHIFT(26),
  [204] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 5, 0, 3),
  [206] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 5, 0, 3),
  [208] = {.entry = {.count = 1, .reusable = true}}, SHIFT(33),
  [210] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family, 1, 0, 0),
  [212] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_family, 1, 0, 0), SHIFT(23),
  [215] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_family, 1, 0, 0),
  [217] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_name_aliases_repeat1, 2, 0, 0), SHIFT_REPEAT(61),
  [220] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_name_aliases_repeat1, 2, 0, 0),
  [222] = {.entry = {.count = 1, .reusable = true}}, SHIFT(10),
  [224] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family, 3, 0, 0),
  [226] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_family, 3, 0, 0),
  [228] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 4, 0, 2),
  [230] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 4, 0, 2),
  ...
  [246] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_new_surname, 3, 0, 0),

...
enum ts_symbol_identifiers {
  ...
  sym_family = 5,
  sym_relation = 6,
  aux_sym_root_repeat1 = 7,
  aux_sym_family_repeat1 = 8,
};
  ...
  switch (state) {
    case 0:
      ...
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ') SKIP(0);
      if (set_contains(sym_name_character_set_1, 611, lookahead)) ADVANCE(3);
      END_STATE();
    case 1:
    ...
    case 3:
      ...
      if (set_contains(sym_name_character_set_2, 432, lookahead)) ADVANCE(3);
      END_STATE();
    default:
      return false;
  }
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [7] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root, 1, 0, 0),
  [9] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family, 2, 0, 0),
  [11] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_family, 2, 0, 0), SHIFT(10),
  [14] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_root_repeat1, 2, 0, 0),
  [16] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_root_repeat1, 2, 0, 0), SHIFT_REPEAT(8),
  [19] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family, 3, 0, 0),
  [21] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_family, 3, 0, 0), SHIFT(10),
  [24] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_family_repeat1, 2, 0, 0),
  [26] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_family_repeat1, 2, 0, 0), SHIFT_REPEAT(10),
  [29] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 4, 0, 0),

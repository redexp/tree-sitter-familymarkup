...
enum ts_symbol_identifiers {
  ...
  sym__words = 24,
  sym__arrows = 25,
  aux_sym_root_repeat1 = 26,
  aux_sym_relations_repeat1 = 27,
  aux_sym_sources_repeat1 = 28,
  aux_sym_targets_repeat1 = 29,
  aux_sym_name_aliases_repeat1 = 30,
  anon_alias_sym__words = 31,
};
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    [sym_root] = STATE(49),
    [sym__multi_newline] = STATE(37),
    [sym__nl] = STATE(37),
    [sym_family] = STATE(18),
    [sym_name_desc] = STATE(30),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [13] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sources, 1, 0, 0),
  [15] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sources, 1, 0, 0),
  [17] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sources, 2, 0, 2),
  [19] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sources, 2, 0, 2),
  [21] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 5), SHIFT_REPEAT(55),
  [24] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 5), SHIFT_REPEAT(51),
  [27] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 5),
  [29] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 5),
  [31] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 5),
  [33] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 5), SHIFT_REPEAT(46),
  [36] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 5), SHIFT_REPEAT(46),
  [39] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 5), SHIFT_REPEAT(51),
  [42] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 2, 0, 3),
  [44] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_relation, 2, 0, 3), SHIFT(14),
  [47] = {.entry = {.count = 1, .reusable = true}}, SHIFT(11),
  [49] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_targets, 2, 0, 2),
  [51] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_targets, 2, 0, 2), SHIFT(46),
  [54] = {.entry = {.count = 1, .reusable = true}}, SHIFT(46),
  [56] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 4),
  [58] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 4),
  [60] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_targets, 1, 0, 0),
  [62] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_targets, 1, 0, 0), SHIFT(46),
  [65] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_desc, 1, 0, 0),
  [67] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_desc, 1, 0, 0),
  [69] = {.entry = {.count = 1, .reusable = true}}, SHIFT(47),
  [71] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 3, 0, 6),
  [73] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_relation, 3, 0, 6), SHIFT(12),
  [76] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 4, 0, 6),
  [78] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 4, 0, 6),
  [80] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root, 2, 0, 0),
  [82] = {.entry = {.count = 1, .reusable = true}}, SHIFT(32),
  [84] = {.entry = {.count = 1, .reusable = false}}, SHIFT(52),
  [86] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 3, 0, 3),
  [88] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 3, 0, 3),
  [90] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root, 3, 0, 0),
  ...
  [106] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_aliases, 2, 0, 0),
  [108] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_aliases, 2, 0, 0),
  [110] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 4),
  [112] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 4),
  [114] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_relations_repeat1, 2, 0, 0),
  [116] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_relations_repeat1, 2, 0, 0), SHIFT_REPEAT(35),
  [119] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_relations_repeat1, 2, 0, 0),
  [121] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_root_repeat1, 2, 0, 0),
  [123] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_root_repeat1, 2, 0, 0), SHIFT_REPEAT(34),
  [126] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_root_repeat1, 2, 0, 0),
  [128] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_desc, 2, 0, 0),
  [130] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_desc, 2, 0, 0),
  [132] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_aliases, 4, 0, 0),
  [134] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_aliases, 4, 0, 0),
  [136] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relations, 1, 0, 0),
  [138] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_relations, 1, 0, 0), SHIFT(35),
  [141] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relations, 1, 0, 0),
  [143] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_aliases, 3, 0, 0),
  [145] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_aliases, 3, 0, 0),
  [147] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relations, 2, 0, 0),
  [149] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_relations, 2, 0, 0), SHIFT(35),
  [152] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relations, 2, 0, 0),
  [154] = {.entry = {.count = 1, .reusable = true}}, SHIFT(2),
  [156] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root, 4, 0, 0),
  [158] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family, 1, 0, 0),
  [160] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_family, 1, 0, 0), SHIFT(28),
  [163] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_family, 1, 0, 0),
  [165] = {.entry = {.count = 1, .reusable = true}}, SHIFT(54),
  [167] = {.entry = {.count = 1, .reusable = true}}, SHIFT(24),
  [169] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 5, 0, 6),
  [171] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 5, 0, 6),
  [173] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_name_aliases_repeat1, 2, 0, 0), SHIFT_REPEAT(54),
  [176] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_name_aliases_repeat1, 2, 0, 0),
  [178] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family, 3, 0, 0),
  [180] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_family, 3, 0, 0),
  [182] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 4, 0, 3),
  [184] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 4, 0, 3),

...
enum ts_symbol_identifiers {
  aux_sym__multi_newline_token1 = 1,
  aux_sym__nl_token1 = 2,
  anon_sym_PLUS = 3,
  anon_sym_COMMA = 4,
  sym_num = 5,
  anon_sym_LPAREN = 6,
  ...
  sym_words = 9,
  anon_sym_EQ = 10,
  anon_sym_LT_DASH_GT = 11,
  anon_sym_DASH_GT = 12,
  anon_sym_LT_DASH = 13,
  anon_sym_DASH = 14,
  sym_root = 15,
  sym__multi_newline = 16,
  sym__nl = 17,
  sym_family = 18,
  sym_relations = 19,
  sym_relation = 20,
  ...
  sym__words = 27,
  sym__arrows = 28,
  aux_sym_root_repeat1 = 29,
  aux_sym_relations_repeat1 = 30,
  aux_sym_sources_repeat1 = 31,
  aux_sym_targets_repeat1 = 32,
  aux_sym_name_aliases_repeat1 = 33,
  anon_alias_sym__words = 34,
};

static const char * const ts_symbol_names[] = {
  [ts_builtin_sym_end] = "end",
  [aux_sym__multi_newline_token1] = "_multi_newline_token1",
...
static const TSSymbol ts_symbol_map[] = {
  ...
  [aux_sym__multi_newline_token1] = aux_sym__multi_newline_token1,
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (set_contains(sym_name_character_set_1, 611, lookahead)) ADVANCE(13);
      if (set_contains(sym_words_character_set_1, 623, lookahead)) ADVANCE(14);
      END_STATE();
    case 1:
      if (lookahead == '\n') ADVANCE(6);
      END_STATE();
    ...
    case 4:
      ...
      END_STATE();
    case 5:
      ACCEPT_TOKEN(aux_sym__multi_newline_token1);
      if (lookahead == '\n') ADVANCE(5);
      if (lookahead == '\r') ADVANCE(2);
      if (('\t' <= lookahead && lookahead <= '\f') ||
          lookahead == ' ') ADVANCE(2);
    ...
    case 13:
      ...
      if (set_contains(sym_name_character_set_2, 434, lookahead)) ADVANCE(13);
      END_STATE();
    case 14:
      ACCEPT_TOKEN(sym_words);
      if (set_contains(sym_words_character_set_2, 627, lookahead)) ADVANCE(14);
      END_STATE();
    case 15:
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  [0] = {
    ...
    [aux_sym__multi_newline_token1] = ACTIONS(1),
  ...
  [1] = {
    [sym_root] = STATE(65),
    [sym__multi_newline] = STATE(26),
    [sym__nl] = STATE(26),
    [sym_family] = STATE(22),
    [sym_name_desc] = STATE(42),
    [sym_new_surname] = STATE(60),
    [aux_sym__multi_newline_token1] = ACTIONS(3),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [15] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_relation, 2, 0, 1), SHIFT(8),
  [18] = {.entry = {.count = 1, .reusable = true}}, SHIFT(5),
  [20] = {.entry = {.count = 1, .reusable = true}}, SHIFT(57),
  [22] = {.entry = {.count = 1, .reusable = true}}, SHIFT(47),
  [24] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sources, 1, 0, 0),
  [26] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sources, 1, 0, 0),
  [28] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 6), SHIFT_REPEAT(57),
  [31] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 6), SHIFT_REPEAT(47),
  [34] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 6),
  [36] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 6),
  [38] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 3, 0, 4),
  [40] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_relation, 3, 0, 4), SHIFT(7),
  [43] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sources, 2, 0, 3),
  [45] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sources, 2, 0, 3),
  [47] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 4, 0, 4),
  [49] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 4, 0, 4),
  [51] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 3, 0, 1),
  [53] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 3, 0, 1),
  [55] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_link, 1, 0, 0),
  [57] = {.entry = {.count = 1, .reusable = true}}, SHIFT(14),
  [59] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_link, 1, 0, 0),
  [61] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 6),
  [63] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 6), SHIFT_REPEAT(31),
  [66] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 6), SHIFT_REPEAT(31),
  [69] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 6), SHIFT_REPEAT(47),
  [72] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_targets, 2, 0, 3),
  [74] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_targets, 2, 0, 3), SHIFT(31),
  [77] = {.entry = {.count = 1, .reusable = true}}, SHIFT(31),
  [79] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 5),
  [81] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 5),
  [83] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_targets, 1, 0, 0),
  [85] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_targets, 1, 0, 0), SHIFT(31),
  [88] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_link, 2, 0, 0),
  [90] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_link, 2, 0, 0),
  [92] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_desc, 2, 0, 0),
  [94] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_desc, 2, 0, 0),
  [96] = {.entry = {.count = 1, .reusable = true}}, SHIFT(56),
  [98] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root, 2, 0, 0),
  [100] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root, 4, 0, 0),
  [102] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_desc, 1, 0, 0),
  [104] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_desc, 1, 0, 0),
  [106] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_desc, 3, 0, 0),
  [108] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_desc, 3, 0, 0),
  [110] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root, 3, 0, 0),
  [112] = {.entry = {.count = 1, .reusable = true}}, SHIFT(2),
  [114] = {.entry = {.count = 1, .reusable = false}}, SHIFT(2),
  [116] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root, 1, 0, 0),
  ...
  [130] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_root_repeat1, 2, 0, 0),
  [132] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_root_repeat1, 2, 0, 0), SHIFT_REPEAT(25),
  [135] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_root_repeat1, 2, 0, 0),
  [137] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 5),
  [139] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 5),
  [141] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_aliases, 2, 0, 0),
  [143] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_aliases, 2, 0, 0),
  [145] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relations, 1, 0, 0),
  [147] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_relations, 1, 0, 0), SHIFT(41),
  [150] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relations, 1, 0, 0),
  [152] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_desc, 4, 0, 0),
  [154] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_desc, 4, 0, 0),
  [156] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_relations_repeat1, 2, 0, 0),
  [158] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_relations_repeat1, 2, 0, 0), SHIFT_REPEAT(41),
  [161] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_relations_repeat1, 2, 0, 0),
  [163] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_aliases, 3, 0, 0),
  [165] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_aliases, 3, 0, 0),
  [167] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_aliases, 4, 0, 0),
  [169] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_aliases, 4, 0, 0),
  [171] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relations, 2, 0, 0),
  [173] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_relations, 2, 0, 0), SHIFT(41),
  [176] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relations, 2, 0, 0),
  [178] = {.entry = {.count = 1, .reusable = true}}, SHIFT(9),
  [180] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family, 1, 0, 0),
  [182] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_family, 1, 0, 0), SHIFT(39),
  [185] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_family, 1, 0, 0),
  [187] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family, 3, 0, 0),
  [189] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_family, 3, 0, 0),
  [191] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 4, 0, 1),
  [193] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 4, 0, 1),
  [195] = {.entry = {.count = 1, .reusable = true}}, SHIFT(61),
  [197] = {.entry = {.count = 1, .reusable = true}}, SHIFT(35),
  [199] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 5, 0, 4),
  [201] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 5, 0, 4),
  [203] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__words, 1, 0, 2),
  [205] = {.entry = {.count = 1, .reusable = true}}, SHIFT(15),
  [207] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_name_aliases_repeat1, 2, 0, 0), SHIFT_REPEAT(61),
  [210] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_name_aliases_repeat1, 2, 0, 0),
  ...
  [224] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_new_surname, 3, 0, 0),

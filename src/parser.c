...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    [sym_root] = STATE(66),
    [sym_family] = STATE(38),
    [sym_name_desc] = STATE(45),
    [sym_new_surname] = STATE(61),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [17] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sources, 1, 0, 0),
  [19] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sources, 1, 0, 0),
  [21] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 2, 0, 1),
  [23] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_relation, 2, 0, 1), SHIFT(6),
  [26] = {.entry = {.count = 1, .reusable = true}}, SHIFT(9),
  [28] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sources, 2, 0, 3),
  [30] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sources, 2, 0, 3),
  [32] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 6), SHIFT_REPEAT(55),
  [35] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 6), SHIFT_REPEAT(46),
  [38] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 6),
  [40] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 6),
  [42] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 3, 0, 1),
  [44] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 3, 0, 1),
  [46] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_link, 1, 0, 0),
  [48] = {.entry = {.count = 1, .reusable = true}}, SHIFT(10),
  [50] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_link, 1, 0, 0),
  [52] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 4, 0, 4),
  [54] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 4, 0, 4),
  [56] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 3, 0, 4),
  [58] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_relation, 3, 0, 4), SHIFT(8),
  [61] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_link, 2, 0, 0),
  [63] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_link, 2, 0, 0),
  [65] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 5),
  [67] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_sources_repeat1, 2, 0, 5),
  [69] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root, 2, 0, 0),
  [71] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_desc, 2, 0, 0),
  [73] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_desc, 2, 0, 0),
  [75] = {.entry = {.count = 1, .reusable = true}}, SHIFT(57),
  [77] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_targets, 1, 0, 0),
  [79] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_targets, 1, 0, 0), SHIFT(27),
  [82] = {.entry = {.count = 1, .reusable = true}}, SHIFT(27),
  [84] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root, 3, 0, 0),
  [86] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_targets, 2, 0, 3),
  [88] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_targets, 2, 0, 3), SHIFT(27),
  [91] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_desc, 3, 0, 0),
  [93] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_desc, 3, 0, 0),
  [95] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_desc, 1, 0, 0),
  [97] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_desc, 1, 0, 0),
  [99] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root, 4, 0, 0),
  [101] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 6),
  [103] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 6), SHIFT_REPEAT(27),
  [106] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 6), SHIFT_REPEAT(27),
  [109] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_targets_repeat1, 2, 0, 6), SHIFT_REPEAT(46),
  [112] = {.entry = {.count = 1, .reusable = true}}, SHIFT(3),
  [114] = {.entry = {.count = 1, .reusable = false}}, SHIFT(3),
  [116] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_aliases, 4, 0, 0),
  [118] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_aliases, 4, 0, 0),
  [120] = {.entry = {.count = 1, .reusable = true}}, SHIFT(7),
  [122] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_aliases, 2, 0, 0),
  [124] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_aliases, 2, 0, 0),
  [126] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_aliases, 3, 0, 0),
  [128] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_aliases, 3, 0, 0),
  [130] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name_desc, 4, 0, 0),
  [132] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name_desc, 4, 0, 0),
  ...
  [142] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relations, 2, 0, 0),
  [144] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_relations, 2, 0, 0), SHIFT(41),
  [147] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relations, 2, 0, 0),
  [149] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_relations_repeat1, 2, 0, 0),
  [151] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_relations_repeat1, 2, 0, 0), SHIFT_REPEAT(41),
  [154] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_relations_repeat1, 2, 0, 0),
  [156] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relations, 1, 0, 0),
  [158] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_relations, 1, 0, 0), SHIFT(41),
  [161] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relations, 1, 0, 0),
  [163] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root, 1, 0, 0),
  [165] = {.entry = {.count = 1, .reusable = true}}, SHIFT(12),
  [167] = {.entry = {.count = 1, .reusable = false}}, SHIFT(59),
  [169] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_root_repeat1, 2, 0, 0),
  [171] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_root_repeat1, 2, 0, 0), SHIFT_REPEAT(23),
  [174] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_root_repeat1, 2, 0, 0),
  ...
  [184] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family, 1, 0, 0),
  [186] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_family, 1, 0, 0), SHIFT(26),
  [189] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_family, 1, 0, 0),
  [191] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__words, 1, 0, 2),
  [193] = {.entry = {.count = 1, .reusable = true}}, SHIFT(13),
  [195] = {.entry = {.count = 1, .reusable = true}}, SHIFT(25),
  [197] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_name_aliases_repeat1, 2, 0, 0), SHIFT_REPEAT(65),
  [200] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_name_aliases_repeat1, 2, 0, 0),
  [202] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_family, 3, 0, 0),
  [204] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_family, 3, 0, 0),
  [206] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 5, 0, 4),
  [208] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 5, 0, 4),
  [210] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation, 4, 0, 1),
  [212] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_relation, 4, 0, 1),
  ...
  [222] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_new_surname, 3, 0, 0),
